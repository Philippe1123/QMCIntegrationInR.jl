...
"""
    ...
    writeOut(Data, "7_v52_res")

    Data = RunSimulation(s, M, N_net, 1, 0.6, DigitalNet64(s))
    writeOut(Data, "8_v52_res")
    ...
    writeOut(Data, "9_v52_res")

    Data = RunSimulation(s, M, N_net, 2, 1.6, DigitalNet64InterlacedTwo(s))
    writeOut(Data, "10_v52_res")
    ...
    writeOut(Data, "11_v52_res")

    Data = RunSimulation(s, M, N_net, 3, 2.6, DigitalNet64InterlacedThree(s))
    writeOut(Data, "12_v52_res")
    """
    ...
    #  plotter(Data)
    writeOut(Data, "13_v52_res")
    """
    Data = RunSimulation(s, M, N_net, 1, 0.6, DigitalNet64(s))
    writeOut(Data, "14_v52_res")
    """
    Data = RunSimulation(
        s,
        M,
    ...
    #   plotter(Data)
    writeOut(Data, "15_v52_res")
    """
    Data = RunSimulation(s, M, N_net, 2, 1.6, DigitalNet64InterlacedTwo(s))
    #   plotter(Data)
    writeOut(Data, "16_v52_res")
    """
    Data = RunSimulation(
        s,
        M,
    ...
    #   plotter(Data)
    writeOut(Data, "17_v52_res")
    """
    Data = RunSimulation(s, M, N_net, 3, 2.6, DigitalNet64InterlacedThree(s))
    #   plotter(Data)
    writeOut(Data, "18_v52_res")
...
function RunSimulation(
    ...
    for ell in N
        ...
        t = @elapsed begin
            ...
            BoxBoundary = sqrt(2 *300* alpha * log(N[end]))
